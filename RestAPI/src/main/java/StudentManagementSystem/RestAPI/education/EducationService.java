package StudentManagementSystem.RestAPI.education;
...
public class EducationService {
    ...
    static {
        ...
        Student student1=new Student("student1","Aparna",new ArrayList<Course>(Arrays.asList(courseI1,courseI2)));
        Student student2=new Student("student2","Vemuganti",new ArrayList<Course>(Arrays.asList(courseII1,courseII2)));
    ...
    public Student retriveSpecificStudent(String studentid) {
        ...
        predicate = student -> student.getId().equalsIgnoreCase(studentid);
